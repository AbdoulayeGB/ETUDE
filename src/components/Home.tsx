      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 mb-8 sm:mb-12 max-w-4xl mx-auto px-4">
            Votre plateforme éducative complète pour apprendre, découvrir et exceller dans
            toutes les matières
          </p>
            ...
            {subjects.map((subject) => (
              ...
              >
                <div className="p-6 sm:p-8">
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 ${subject.color} rounded-2xl mb-4 sm:mb-6 transition-colors duration-300`}
                  >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="text-center p-6 sm:p-8 bg-white rounded-2xl shadow-lg sm:col-span-2 lg:col-span-1">
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
              ...
              <p className="text-sm sm:text-base text-gray-600">
                Suivez vos progrès en temps réel et identifiez vos points fort et axes
                d'amélioration
              </p>
            </div>
          </div>
