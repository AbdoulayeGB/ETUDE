...
import { useSubjects, useCourses } from '../hooks/useSubjects';
...
const SubjectPage: React.FC<SubjectPageProps> = ({ subject, onSelectCourse }) => {
  ...
  useEffect(() => {
    const found = subjects.find((s) => s.slug === subject);
          ...
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              {selectedSubject.description ||
                'Découvrez les cours disponibles pour cette matière.'}
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-2">
                ...
                {courses.length > 0 ? (
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center space-x-4 text-sm text-gray-500">
                              ...
                              {course.media_type && course.media_type !== 'texte' && (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">
                      Les cours pour cette matière seront bientôt disponibles.
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="text-center p-6 border border-gray-200 rounded-lg hover:border-cyan-300 hover:bg-cyan-50 transition-colors duration-200 cursor-pointer">
...
export { getYouTubeEmbedUrl, isPdf };
